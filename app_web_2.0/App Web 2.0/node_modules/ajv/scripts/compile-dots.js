...
files.forEach(function (f) {
  ...
  // file deepcode ignore Ssti: <please specify a reason of ignoring this>
...
// Ejemplo: no permitir expresiones demasiado complejas
if (regexp.toString().length > 100) {
  throw new Error('RegExp is too long');
}
